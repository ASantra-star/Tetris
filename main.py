...
class Figure:
    ...
    figures = [
      ...
      [[1, 2, 5, 6]], [[2, 6, 10, 11], [3, 5, 6, 7], [1, 5, 6, 10]],
      [[11, 12, 13, 14, 15], [1, 5, 6, 9, 13], [4, 5, 6, 9, 13], [1, 2, 5, 6, 9]]
    ]
...
while not done:
    ...
    text_game_over = font1.render("Game Over", True, (236, 36, 12))
    text_game_over1 = font1.render("Press ESC", True, (10, 64, 197 ))
